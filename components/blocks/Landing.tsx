...
export default function Landing({lang}: {lang:'en' | 'sv'}) {
    ...
    if (!isMobile) {
        return (
            <div className="flex justify-evenly items-center h-[90vh]">
                <div>
                    ...
                    :
                    <>
                    <h1 className="text-6xl font-bold leading-snug">Hej,<br />Jag är <span className="text-blue">Linus</span><br />Webbutvecklare</h1>
                    <a href="#contact"><button className="my-12 bg-blue px-8 py-3 border-2 border-blue rounded-3xl text-white font-semibold text-xl hover:bg-white hover:text-blue transition duration-300 ease-in-out">Kontakt</button></a>
                    </>
                    }
        ...
        <div className="flex flex-col justify-evenly items-center h-[70vh] mt-4">
            ...
            :
            <>
            <h1 className="text-2xl font-bold leading-snug text-center mt-12">Hej,<br />Jag är <span className="text-blue">Linus</span><br />Utvecklare</h1>
            <a href="#contact"><button className="bg-blue px-4 mt-4 py-2 border-2 border-blue rounded-3xl text-white font-semibold text-xl hover:bg-white hover:text-blue transition duration-300 ease-in-out">Kontakt</button></a>
            </>
            }
